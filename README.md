...
### 7. 브라우저 테스트
 1) 소나큐브 : http://192.168.99.100.82:9000/ 
 2) 젠킨스: http://192.168.99.100.82:8080/ 
 3) gitlab: http://192.168.99.100.82/ > 로딩이 오래 걸림 
 4) 넥서스: http://192.168.99.100.82:8081/nexus 
 5) docker registry: http://192.168.99.100.82:5000/v2/ 
  => "{}" 값 확인 하면 됨. 
 6) eclipse-che: http://192.168.99.100.82:8082 
